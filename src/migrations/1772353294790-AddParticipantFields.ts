...
export class AddParticipantFields1772353294790 implements MigrationInterface {
    name = 'AddParticipantFields1772353294790'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`participantType\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`minTeams\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`regOpenDate\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`regCloseDate\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`approvalRequired\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`regFee\` decimal(10,2) NOT NULL DEFAULT '0.00'`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`playerLimit\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`tournament\` ADD \`squadSize\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_368e146b785b574f42ae9e53d5e\` FOREIGN KEY (\`roleId\`) REFERENCES \`user_role\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`squadSize\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`playerLimit\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`regFee\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`approvalRequired\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`regCloseDate\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`regOpenDate\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`minTeams\``);
        await queryRunner.query(`ALTER TABLE \`tournament\` DROP COLUMN \`participantType\``);
    }
